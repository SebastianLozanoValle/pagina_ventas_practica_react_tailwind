...
import {RiHome6Line, RiPercentLine, RiPieChartLine, RiMailLine, RiNotification3Line, RiSettings4Line, RiLogoutCircleLine} from 'react-icons/ri'
const Sidebar = () => {
    return (
            ...
            <div>
                <ul className='pl-4'>
                    ...
                    <li className='bg-[#262837] p-4 rounded-tl-xl rounded-bl-xl'>
                        <a href='#' className='bg-[#ec7c6a] p-4 flex justify-center rounded-xl'>
